...
class OrderController extends Controller
{
    public function store(Request $request)
    {
        ...
        if(empty(Cart::where('user_id',auth()->user()->id)->where('order_id',null)->first())){
            request()->session()->flash('error','Cart Kosong !');
            return back();
        }
        if(empty(Shipping::where('id', $request->shipping)->first())){
            request()->session()->flash('error','Silahkan Isi Shipping!');
            return back();
        }
        // $cart=Cart::get();
        // // return $cart;
        ...
        if(request('payment_method')=='money' && $money->money< $order->total_amount){
            request()->session()->flash('error','Isi Saldomu');
            return back();
            }
        ...
        // dd($users);        
        request()->session()->flash('success',' Anda Berhasil Memesan');
