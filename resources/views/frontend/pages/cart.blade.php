        ...
        <div class="container custom-area">
            <div class="row">
                <div class="col-lg-12 col-custom">
                    <!-- Cart Table Area -->
                    <form class="cart-table table-responsive" action="{{route('cart.update')}}" method="POST">
                        @csrf
                        ...
                        @if (Helper::getAllProductFromCart())
                            @foreach (Helper::getAllProductFromCart() as $key=>$cart)          
                                <tr>
									...
									@endphp                    
                                    <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="{{$photo[0]}}" alt="{{$photo[0]}}" /></a></td>
                                    <td class="pro-title"><a href="#">{{$cart->product['title']}}<br></a></td>
                                    <td class="pro-price"><span>Rp.{{number_format($cart['price'],2)}}</span></td>
                                    <td class="pro-quantity">
                                        <div class="quantity">
                                            <div class="cart-plus-minus">
                                                <input class="cart-plus-minus-box" name="quant[{{$key}}]" value="{{$cart->quantity}}" type="text">
                                    ...
                                    <td class="pro-subtotal"><span>Rp.{{number_format($cart['amount'])}}</span></td>
                                    <td class="pro-remove"><a href="{{route('cart-delete',$cart->id)}}"><i class="lnr lnr-trash"></i></a></td>                            
                                </tr>
                            @endforeach
                        @else
                        <tr>
                        ...
                        {{--<div class="cart-update mt-sm-16">
                            <button class="btn flosun-button primary-btn rounded-0 black-btn">Update Cart</button>
                        </div>--}}
                    </form>
                    <!-- Cart Update Option -->
                        ...
                        <div class="cart-calculate-items">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tr>
                                        <td>Sub Total</td>
                                        <td data-price="{{Helper::totalCartPrice()}}">Rp.{{number_format(Helper::totalCartPrice(),2)}}</td>
                                    </tr>
                                    <tr>
                                        @if(session()->has('coupon'))
                                        <td>Kamu Untung</td>
                                        <td class="total-amount" data-price="{{Session::get('coupon')['value']}}">Rp.{{number_format(Session::get('coupon')['value'],2)}}</td>
                                        @endif
                                    </tr>
                                        @php
                                    ...
                                    <tr class="total">
                                        @if(session()->has('coupon'))
                                        <td>Total</td>
                                        <td class="total-amount">Rp.{{number_format($total_amount,2)}}</td>
                                        @else
                                        <td class="total-amount">Rp.{{number_format($total_amount,2)}}</td>
                                        @endif
                                    </tr>
