                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="pro-stock">Rating</td>
                                        <th class="pro-cart">Add to Cart</th>
                                        <th class="pro-remove">Remove</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @if(Helper::getAllProductFromCompare())
                                    @foreach(Helper::getAllProductFromCompare() as $key=>$compare)
                                        <tr>
                                            <td class="pro-title"><a href="#">{{$compare->product['title']}} <br></a></td>
                                            <td class="pro-price"><span>Rp{{number_format($compare['amount'],2)}}</span></td>
                                            ...
                                            <td class="pro-cart"><a href="{{route('add-to-cart',$compare->product['slug'])}}" class="btn product-cart button-icon flosun-button dark-btn">Add to Cart</a></td>
                                            <td class="pro-remove"><a href="{{route('compare-delete',$compare->id)}}"><i class="lnr lnr-trash"></i></a></td>
                                        </tr>
                                    @endforeach
                                        @else 
                                            <tr>
                                                <td class="text-center">
                                                There are no any wishlist available. <a style="color:blue;">Continue shopping</a>
