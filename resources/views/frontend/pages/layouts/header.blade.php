                       ...
                       <ul class="nav">
                               ...
                               <div class="mega-menu dropdown-hover">
                                   <div class="menu-colum">
                                       <ul>
                                           ...
                                           <li><a href="{{route('product.list')}}">Shop Left Sidebar</a></li>
                                       </ul>
                                   </div>
                                   <div class="menu-colum">
                                       <ul>
                           ...
                           <li>
                               ...
                               <ul class="dropdown-submenu dropdown-hover">
                                   ...
                                   @else
                                   <li><a href="my-account.html">Dashboard user</a></li>
                                   @endif
                               @else
                           ...
                           <li>
                               <a href="{{route('about.us')}}">
                                   <span href="{{route('about.us')}}"> About Us</span>
                               </a>
                           </li>
                           <li>
                           ...
                           <li class="minicart-wrap">
                               ...
                               <div class="cart-item-wrapper dropdown-sidemenu dropdown-hover-2">
                                   ...
                                   <div class="cart-links d-flex justify-content-between">
                                       <a class="btn product-cart button-icon flosun-button dark-btn" >View cart</a>
           ...
           <div class="off-canvas-inner">
               ...
               <div class="mobile-navigation">
                   ...
                   <nav>
                       <ul class="mobile-menu">
                           <li class="menu-item-has-children"><a>Home</a>
                               <ul class="dropdown">
                                   <li><a href="/">Home </a></li>
                               </ul>
                           </li>
                           ...
                           <li class="menu-item-has-children "><a href="#">Pages</a>
                               <ul class="dropdown">
                                   ...
                                   @auth
                                        @if (Auth::user()->role=='admin')
                                        <li><a href="my-account.html">Dashboard admin</a></li>
                                        @else
                                        <li><a href="my-account.html">Dashboard user</a></li>
                                        @endif
                                    @else
               ...
               <div class="offcanvas-widget-area">
                   <div class="switcher">
                       ...
                       <div class="currency">
                           <span class="switcher-title">Dashboard: </span>
                           <div class="switcher-menu">
                               <ul>
                                   <li><a href="#">$ USD</a>
                                   </li>
                   ...
                   <div class="top-info-wrap text-left text-black">
                       <ul class="address-info">
                           <li>
                               ...
                               <a href="info%40yourdomain.html">wido</a>
                           </li>
                           <li>
