                    ...
                    <div class="login-register-wrapper">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="flex items-center justify-end mt-4">
                                ...
                                @endif
                                <div class="single-input-item mb-3">
                                    <x-button class="btn flosun-button secondary-btn theme-color rounded-0">
                                        {{ __('Log in') }}
                                    </x-button>
                                    or
                                    <a href="{{route('login.redirect','google')}}" class="btn flosun-button secondary-btn theme-color rounded-0"><i class="fa fa-facebook"></i></a>
                                    <a href="{{route('login.redirect','google')}}" class="btn flosun-button secondary-btn theme-color rounded-0"><i class="fa fa-google"></i></a>
                                    <a href="" class="btn flosun-button secondary-btn theme-color rounded-0"><i class="fa fa-twitter"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
