                            ...
                            <tbody>
								...
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
                                    <tr>
                                        ...
                                        <td class="pro-title"><a href="#">{{$wishlist->product['title']}} <br></a></td>
                                        <td class="pro-price"><span>Rp{{number_format($wishlist['amount'],2)}}</span></td>
                                        <td class="pro-stock"><span><strong>In Stock</strong></span></td>
                                        <td class="pro-cart"><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class="btn product-cart button-icon flosun-button dark-btn">Add to Cart</a></td>
                                        <td class="pro-remove"><a href="{{route('wishlist-delete',$wishlist->id)}}"><i class="lnr lnr-trash"></i></a></td>
                                    </tr>
                                @endforeach
                                    @else 
                                        <tr>
