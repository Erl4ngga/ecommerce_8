                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-custom">
                                <div class="myaccount-tab-menu nav" role="tablist">
                                    ...
                                    <a href="#payment-method" data-bs-toggle="tab"><i class="fa fa-credit-card"></i> Gro-mart</a>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        @if(count($orders)>0)
                                                            ...
                                                            <td><a href="{{route('user.order.show',$order->id)}}" class="btn flosun-button secondary-btn theme-color  rounded-0">View</a></td>
                                                            </tr>
                                                            @endforeach
                                                        @else
                                                    ...
                                                    <tbody>
                                                        @foreach ($orders as $order)
                                                            <tr>
                                                                ...
                                                                <td><a href="{{route('order.pdf',$order->id)}}" class="btn flosun-button secondary-btn theme-color  rounded-0"><i class="fa fa-cloud-download mr-2"></i>Download File</a></td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
